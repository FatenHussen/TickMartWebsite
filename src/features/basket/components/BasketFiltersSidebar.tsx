...
export default function BasketFiltersSidebar({
    ...
    return (
        <div className="space-y-6">
            {/* Basket Type */}
            <div className="bg-custom-card rounded-xl p-5 shadow-sm">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                filters.basketType === value
                                    ...
                                    : "bg-custom-light text-custom-primary hover:bg-custom-tertiary"
                            )}
                        >
                            {t(labelKey)}
                        </button>
            ...
            <div className="bg-custom-card rounded-xl p-5 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                    <input
                        ...
                        className="w-full rounded-lg border border-custom-primary px-3 py-2 text-sm outline-none focus:border-primary-light"
                    />
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                filters.ratingMin === star
                                    ...
                                    : "bg-custom-light text-custom-primary border-custom-primary hover:border-primary-light"
                            )}
                        >
                            ★ {star}+
                        </button>
