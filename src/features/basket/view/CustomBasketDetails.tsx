...
export default function CustomBasketDetails({
 ...
 {/* Breadcrumb */}
 <div className="flex items-center gap-2 text-sm text-custom-secondary mb-6">
 ...
 <HiChevronRight className="w-4 h-4"/>
 <span className="text-custom-primary font-medium">{basket.name}</span>
 </div>

 {/* Page Title */}
 <h1 className="text-2xl font-bold text-custom-primary mb-6">Basket details</h1>

 {/* Basket Header */}
 <div className="bg-blue-50 rounded-xl p-6 mb-6">
 <div className="flex flex-col md:flex-row gap-6">
 {/* Image */}
 <div className="w-full md:w-48 h-48 rounded-xl overflow-hidden shrink-0 bg-custom-card">
 <img
 src={basket.image}
 alt={basket.name}
 ...
 {basket.is_on_offer && (
 <span className="px-3 py-1 bg-yellow-400 text-custom-primary text-xs font-semibold rounded">
 Special offer today
 </span>
 )}
 </div>
 ...
 <div className="flex items-center gap-6 text-sm text-custom-secondary mb-4">
 <div className="flex items-center gap-1">
 <span className="font-semibold text-custom-primary">{productItems.length}</span>
 <span>items •</span>
 <span className="font-semibold text-custom-primary">{basket.num_varieties}</span>
 ...
 <span className="text-4xl font-bold text-custom-primary">
 ${basket.final_price.toFixed(2)}
 </span>
 {basket.original_price > basket.final_price && (
 <>
 <span className="text-xl text-custom-tertiary line-through">
 ...
 <div className="flex items-center justify-between bg-custom-card rounded-lg shadow-sm p-4 mb-6">
 ...
 <div className="text-custom-secondary mb-1">Price per basket</div>
