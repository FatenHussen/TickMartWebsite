...
"automatic"
 ...
 {selectedSchedule && (
 <span className="px-3 py-1 bg-custom-tertiary text-custom-primary text-xs font-medium rounded-full">
 ...
 <span className="text-custom-primary">{basket.next_delivery_date ??"-"}</span>
 </div>
 </div>
 </div>
 ...
 <span className="text-custom-secondary">{productItems.length} {t("baskets.totalItems")}</span>
 <span className="text-custom-tertiary">|</span>
 <span className="text-custom-secondary">{t("recipes.quantity")}: {totalQuantity}</span>
 </div>
 </div>
 <div className="flex items-center gap-6">
 <div className={isRTL ?"text-left":"text-right"}>
 <div className="text-sm text-custom-secondary">{t("baskets.subtotal")}: ${subtotal.toFixed(2)}</div>
 ...
 {/* Delivery Summary */}
 <div className="bg-cyan-50 border-2 border-cyan-200 rounded-lg p-6 mb-6">
 <h3 className="text-lg font-bold text-custom-primary mb-4">{t("baskets.deliverySummary")}</h3>
 ...
 <div>
 <h4 className="font-semibold text-custom-primary">{t("baskets.deliveryAddress")}</h4>
 </div>
 </div>
 <div className="ml-11">
 ...
 <div>
 <h4 className="font-semibold text-custom-primary">{t("baskets.nextDelivery")}</h4>
 </div>
 </div>
 <div className="ml-11">
 <p className="text-sm text-custom-secondary mb-1">
 ...
 <div>
 <h4 className="font-semibold text-custom-primary">{t("baskets.paymentMethod")}</h4>
 </div>
 </div>
 <div className="ml-11">
 <p className="text-sm text-custom-secondary mb-1">
 ...
 <div
 key={extra.id}
 className="flex items-center gap-4 p-3 border border-custom-primary rounded-xl hover:border-cyan-300 hover:bg-cyan-50/50 transition cursor-pointer group"
