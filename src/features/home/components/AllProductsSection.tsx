...
const darkSelectClass =
    "w-full rounded-xl border border-white/[0.07] bg-[rgba(16,17,20,0.7)] px-4 py-2.5 text-[#A1A1AA] text-sm backdrop-blur-sm transition-colors duration-200 focus:border-white/[0.14] focus:outline-none focus:ring-1 focus:ring-white/[0.10] hover:border-white/[0.10]";

const lightSelectClass =
    "w-full rounded-xl border border-stone-200 bg-white px-4 py-2.5 text-stone-800 text-sm transition-colors focus:border-stone-300 focus:outline-none focus:ring-2 focus:ring-black/5";
...
export default function AllProductsSection({
    ...
    const labelClass = isDarkTheme
        ...
        : "block text-sm font-medium text-stone-600 mb-2";
                    ...
                    <div>
                        <h2
                            ...
                            style={
                                isDarkTheme
                                    ? { color: "#FFFFFF" }
                                    : { color: "var(--color-custom-primary, #111827)" }
                            }
                        >
                            {titleText}
                        </h2>
                ...
                <div className="mb-8 flex flex-wrap gap-4 items-end">
                    <div className="flex-1 min-w-[180px]">
                        ...
                        >
                            ...
                            {isFetchingMoreCats && <option value="" disabled>{t("common.loading")}</option>}
                        </select>
                    </div>
                    ...
                    <div className="flex-1 min-w-[180px]">
                        ...
                        >
                            ...
                            {isFetchingMoreBrands && <option value="" disabled>{t("common.loading")}</option>}
                        </select>
                    </div>
                    ...
                    <div className="flex-1 min-w-[180px]">
                        ...
                        <select
                            value={shopFilter || ""}
                            onChange={(e) => setShopFilter(e.target.value ? Number(e.target.value) : undefined)}
                        ...
                        >
                            ...
                            {isFetchingMoreShops && <option value="" disabled>{t("common.loading")}</option>}
                        </select>
                    </div>
                </div>
