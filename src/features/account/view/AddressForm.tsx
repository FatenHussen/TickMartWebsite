      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex rounded-xl border border-gray-300 dark:border-gray-600 overflow-hidden bg-white dark:bg-gray-800">
            <div className="px-4 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-sm font-medium shrink-0">
              {t("account.addAddress.phonePrefix")}
            </div>
            <input
              type="tel"
              placeholder={t("account.addAddress.contactPhonePlaceholder")}
              className="flex-1 min-w-0 px-4 py-2.5 text-sm text-gray-900 dark:text-white bg-transparent focus:outline-none focus:ring-0 placeholder:text-gray-400"
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <HiSearch className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500" />
            <input
              type="text"
              placeholder={t("account.addAddress.searchLocationPlaceholder")}
              readOnly
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 text-gray-500 dark:text-gray-400 text-sm"
            />
          </div>
          <LocationPickerMap
            lat={lat}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:border-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors text-sm font-medium"
          >
            <svg
              className="w-5 h-5"
              fill="none"
