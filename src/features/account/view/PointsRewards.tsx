  ...
  if (hasSummaryError) {
    return (
      <div className="space-y-6" dir={isRTL ? "rtl" : "ltr"}>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 text-center text-gray-600 dark:text-gray-400">
    ...
    <div className="space-y-8" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6">
          ...
          {isLoading ? (
            <div className="h-32 flex items-center justify-center text-gray-600 dark:text-gray-400">
            ...
            <>
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                <div>
                  {t("account.pointsRewards.pointValue")}: 1{" "}
                  {t("account.pointsRewards.points")} = {POINT_VALUE_SYP} SYP
                </div>
                <div>
                  {t("account.pointsRewards.estimatedValue")}: ≈{" "}
                  {estimatedValue.toLocaleString()} SYP{" "}
              ...
              <div className="mt-4">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
                  {t("account.pointsRewards.nextReward")}{" "}
                  {NEXT_REWARD_THRESHOLD.toLocaleString()}{" "}
                  {t("account.pointsRewards.points")}
                </p>
              </div>
            </>
          ...
          {expireAt && (
            <div className="bg-orange-100 dark:bg-orange-900/20 border border-orange-300 dark:border-orange-700 rounded-lg p-4 mb-6 flex items-start gap-3">
              ...
              <div className="text-sm text-orange-700 dark:text-orange-400">
                ...
                {formatDate(expireAt)}
                {pendingPoints > 0 &&
                  ` – ${pendingPoints} ${t("account.pointsRewards.points")} ${t("account.pointsRewards.expiry.willExpire")}`}
              </div>
            </div>
          )}
        ...
        {exchangeLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="border border-gray-200 dark:border-gray-700 rounded-lg p-5 animate-pulse h-44 bg-blue-50/50 dark:bg-gray-700/30"
              />
            ))}
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {exchangeOptions?.options?.coupon?.enabled && (
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-gray-200 dark:border-gray-700 rounded-lg p-5 hover:shadow-md transition-shadow">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-gray-200 dark:border-gray-700 rounded-lg p-5 hover:shadow-md transition-shadow">
                ...
                <div className="text-xl font-bold text-blue-500 dark:text-blue-400 mb-2">
                  {exchangeOptions.options.gifts.available_gifts?.[0]
                    ? `${exchangeOptions.options.gifts.available_gifts[0].points_required} ${t("account.pointsRewards.points")} = ${exchangeOptions.options.gifts.available_gifts[0].points_required * POINT_VALUE_SYP} SYP ${t("account.pointsRewards.redeem.options.voucher")}`
            ...
            {!exchangeLoading &&
              ...
              !exchangeOptions?.options?.free_delivery?.enabled &&
              !exchangeOptions?.options?.gifts?.enabled && (
                <div className="col-span-full text-sm text-gray-600 dark:text-gray-400 py-4">
            ...
            <button
              ...
              className={cn(
                ...
                activeFilter === tab.value
                  ...
                  : "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300/50 dark:hover:bg-gray-600/50",
              )}
            >
              {tab.label}
            </button>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-3 px-4 text-base font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <th className="text-right py-3 px-4 text-base font-medium text-gray-700 dark:text-gray-300">
                  ...
                  itemsWithBalance.map(
                    (item: PointsTransactionItem & { displayBalance: number }) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4 text-sm text-gray-800 dark:text-gray-200 text-right">
