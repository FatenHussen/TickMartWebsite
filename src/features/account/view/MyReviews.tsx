...
export default function MyReviews() {
 ...
 <p className="text-xs text-custom-tertiary sm:text-right whitespace-nowrap">
 ...
 <span className="text-sm text-custom-primary whitespace-nowrap">
...
"px-4 py-2 rounded-full text-sm font-medium transition-all",
 ...
 :"border border-custom-secondary bg-custom-card text-custom-primary hover:bg-custom-light"
 )}
 >
 {tab.label}
 </button>
...
"flex flex-wrap items-center gap-3 mb-6",
 ...
 <button className="flex items-center gap-2 px-4 py-2 rounded-lg border border-custom-secondary bg-custom-card text-custom-primary hover:bg-custom-light transition-colors">
 ...
 <div className="bg-custom-card rounded-xl border border-custom-primary divide-y divide-custom-primary overflow-hidden">
