      ...
      <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className={cn(
              "w-full py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary",
              ...
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ...
                    : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-primary/10 hover:text-primary dark:hover:bg-primary/20"
                )}
              >
                {t(localeKey)}
              </button>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isOpen ? (
                      <HiChevronUp className="w-5 h-5 shrink-0 text-gray-500" />
                    ) : (
                      <HiChevronDown className="w-5 h-5 shrink-0 text-gray-500" />
                    )}
                  </button>
                  {isOpen && (
                    <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 text-sm">
                      {faq.answer}
                    </div>
                  )}
                </div>
        ...
        >
          {contact?.whatsapp && (
            <a
              ...
              className="flex flex-col items-center justify-center gap-3 p-6 rounded-xl border-2 bg-white dark:bg-gray-800 border-[var(--contact-border,#E4F0FB)] dark:border-gray-600 hover:border-primary/50 transition-colors min-h-[120px]"
            >
          ...
          {contact?.email && (
            ...
            >
              <HiMail
                className="w-10 h-10 text-gray-600 dark:text-gray-500 shrink-0"
              />
              <span
                className="text-sm font-medium text-center"
                style={{ color: "var(--contact-text, #2A2A2A)" }}
...
function ComplaintFormSection({
  ...
  return (
    <form
      ...
      className="rounded-xl bg-white dark:bg-gray-800 p-6 space-y-5 mb-6"
    >
...
function ComplaintAccordionCard({
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-600 overflow-hidden hover:shadow-md transition-shadow">
      ...
      {/* Accordion body */}
      {expanded && (
        <div className="border-t border-gray-200 dark:border-gray-600 bg-gray-50/50 dark:bg-gray-800/50 px-4 py-4 space-y-4">
          {/* Full Description */}
          <div>
