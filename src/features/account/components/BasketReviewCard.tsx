...
type BasketReviewCardProps = {
 review: BasketReview;
 onEdit?: (id: string | number) => void;
 compact?: boolean;
};

export default function BasketReviewCard({
 review,
 onEdit,
 compact = false,
}: BasketReviewCardProps) {
