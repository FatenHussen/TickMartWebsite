...
"The store has already started preparing your order. If you cancel now, a cancellation fee will be deducted from your refund. The rest of the amount will be refunded to your original payment method."
 ...
 className="mt-1 rounded border-custom-secondary"
 />
...
"I understand that a cancellation fee will be applied and the remaining amount will be refunded."
 ...
 {isPending && (
 <div className="p-4 rounded-xl bg-custom-tertiary space-y-1">
 ...
 <p className="text-sm text-custom-secondary">{storeLabel}</p>
 ...
 type="button"
 onClick={handleClose}
 className="flex-1 py-2.5 rounded-xl border border-custom-secondary text-custom-primary hover:bg-custom-light font-medium text-sm"
 >
