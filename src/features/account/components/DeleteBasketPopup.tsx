...
export default function DeleteBasketPopup({
 ...
 >
 {/* Basket Card Preview */}
 <div className="bg-custom-light rounded-xl p-4 mb-4">
 ...
 <span className="font-medium text-custom-primary truncate">
 {basketName}
 </span>
 ...
 {nextRunDate && (
 <div className="text-xs text-custom-secondary mt-0.5">
 ...
 {/* Warning Text */}
 <p className="text-xs text-custom-secondary text-center mb-4">
