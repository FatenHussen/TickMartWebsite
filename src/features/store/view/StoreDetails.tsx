            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6">
              ...
              >
                <div className="relative">
                  <HiSearch
                    className={`absolute top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500 ${isRTL ? "right-3" : "left-3"}`}
                  />
                  <input
                    type="text"
                    value={searchInput}
                    ...
                    className={`w-full py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-custom-primary placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-light/20 focus:border-primary-light ${
              ...
              <select
                ...
                className="px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-custom-primary focus:outline-none focus:ring-2 focus:ring-primary-light/20 min-w-[160px]"
              >
