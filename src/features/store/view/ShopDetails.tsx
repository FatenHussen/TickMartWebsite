...
export default function ShopDetails() {
 ...
 {/* Shop Description */}
 {shop.description && (
 <div className="mt-6 bg-custom-card rounded-2xl p-6 shadow-sm border border-custom-primary">
 ...
 <div className="bg-custom-card rounded-2xl p-4 shadow-sm border border-custom-primary">
 ...
 <div className="bg-custom-card rounded-2xl p-4 shadow-sm border border-custom-primary md:col-span-2">
 ...
 const topBadge = product.top_badges?.find(
 (b: { postion?: string }) => b.postion === "top"
 );
