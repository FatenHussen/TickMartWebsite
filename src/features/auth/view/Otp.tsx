      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-8">
        ...
        <OTPInput
          ...
          renderInput={(props: InputHTMLAttributes<HTMLInputElement>) => (
            <input
              {...props}
              className="!w-12 h-12 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-center text-lg font-semibold text-gray-900 dark:text-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all [appearance:textfield]"
            />
          )}
        />
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <button
            ...
            className="text-primary font-medium hover:underline disabled:text-gray-400 dark:disabled:text-gray-500 disabled:cursor-not-allowed disabled:no-underline"
          >
