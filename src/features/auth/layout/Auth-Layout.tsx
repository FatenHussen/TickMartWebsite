...
export default function AuthLayout({
 ...
 <div className="w-32 h-40 bg-custom-card rounded-2xl shadow-lg p-2 flex items-center justify-center">
 ...
 <div className="absolute -top-2 -right-2 w-3 h-3 bg-custom-card rounded-full opacity-60"/>
 <div className="absolute top-4 right-6 w-2 h-2 bg-custom-card rounded-full opacity-50"/>
 </div>
 </div>
 )}
 </div>
 <div className="w-full max-w-sm bg-custom-card rounded-2xl shadow-xl p-6">
 ...
 <button
 type="button"
 className="flex items-center justify-center gap-2 w-full max-w-sm bg-yellow-400 hover:bg-yellow-500 dark:bg-yellow-500 dark:hover:bg-yellow-600 text-custom-primary px-5 py-4 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
 >
 ...
 <main className="flex items-center justify-center px-6 md:px-10 py-10 bg-custom-card">
