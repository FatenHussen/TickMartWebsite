...
export default function OrderSummary({
 ...
 return (
 <div className="bg-custom-card rounded-2xl border border-custom-primary shadow-sm p-6 sticky top-4">
 ...
 <span className="text-custom-secondary">Items total:</span>
 ...
 <div className="flex items-center justify-between text-sm">
 <span className="text-custom-secondary">Delivery fees:</span>
 <span className="font-medium text-text-primary">{summary.deliveryFees}</span>
 </div>
 <div className="flex items-center justify-between text-sm">
 <span className="text-custom-secondary">Service fee:</span>
 <span className="font-medium text-text-primary">{summary.serviceFee}</span>
 </div>
 </div>

 {/* Total */}
 <div className="flex items-center justify-between py-4 border-t border-custom-primary mb-6">
