...
export default function BecomeMarketer() {
  ...
  if (isAffiliate && !isApproved) {
    return (
      <div
        className="min-h-screen bg-gray-200 dark:bg-gray-900 flex items-center justify-center p-4"
        dir={isRTL ? "rtl" : "ltr"}
      >
  ...
  return (
    <div
      className="min-h-screen bg-gray-200 dark:bg-gray-900 py-8 px-4"
      dir={isRTL ? "rtl" : "ltr"}
    >
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="px-6 py-5">
                <div
                  className="prose prose-sm max-w-none text-gray-600 dark:text-gray-300 leading-relaxed space-y-4"
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-3 justify-end mt-6">
                  <Link
                    to={paths.client.home}
                    className="px-5 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-center"
                  >
            ...
            <p className="text-gray-600 dark:text-gray-400 py-8 text-center px-6">
      ...
      {showSuccessModal && (
        <>
          ...
          >
            <div
              className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-8 relative"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button - light gray circle */}
              <button
                onClick={handleCloseModal}
                className="absolute top-4 end-4 w-9 h-9 rounded-full bg-gray-200 dark:bg-gray-600 text-gray-500 dark:text-gray-400 flex items-center justify-center hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors"
              >
              ...
              <div className="text-gray-600 dark:text-gray-400 text-center space-y-2 mb-8 text-sm">
                <p>
