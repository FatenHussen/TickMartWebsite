            ...
            {quickActions.map((action) => {
              ...
              return (
                <Link
                  key={action.id}
                  to={action.path}
                  className="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-md hover:border-primary-light/30 transition-all group"
                >
                  <div
                  ...
                  <HiArrowRight className="w-4 h-4 text-gray-400 group-hover:text-primary-light transition-colors shrink-0" />
                </Link>
              );
            })}
          </div>
