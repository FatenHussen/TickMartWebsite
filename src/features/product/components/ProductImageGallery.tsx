        ...
        <div className="absolute right-4 top-4 z-10 flex gap-2">
          {onShare && (
            <Button
              ...
              onClick={onShare}
              className="h-10 w-10 rounded-xl bg-white/95 p-0 shadow-sm ring-1 ring-slate-200 hover:bg-white"
            >
        ...
        <div className="relative flex items-center">
          ...
          {canGoPrev && (
            <button
              ...
              className="absolute left-0 z-10 grid h-9 w-9 place-items-center rounded-xl bg-white shadow-sm ring-1 ring-slate-200 hover:bg-slate-50"
          ...
          {canGoNext && (
            <button
              ...
              className="absolute right-0 z-10 grid h-9 w-9 place-items-center rounded-xl bg-white shadow-sm ring-1 ring-slate-200 hover:bg-slate-50"
