...
export default function ShopSelector({
 ...
 className="appearance-none rounded-full border border-custom-primary bg-custom-primary pl-3 pr-7 py-1 text-xs font-medium text-custom-primary outline-none transition-colors focus:border-primary-light cursor-pointer"
 >
 {shops.map((shop) => (
 ...
 <HiChevronDown className="pointer-events-none absolute right-2 h-3 w-3 text-custom-secondary"/>
 </div>
