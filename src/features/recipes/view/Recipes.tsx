            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-700 outline-none focus:ring-2 focus:ring-primary-light focus:border-transparent dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                />
              </div>
              ...
              <select
                ...
                className="px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-700 outline-none focus:ring-2 focus:ring-primary-light focus:border-transparent dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
              >
